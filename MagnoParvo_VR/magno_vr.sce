...
# 6/10/2004 new pictures
#6/10/2004  renamed correct pcl file to be magno_vr.pcl  RV
   
pcl_file = "magno_vr.pcl";
...
array {
 ...
 picture { bitmap { filename =  "dwarfgroup.bmp";}; x = 0; y = 0; } groupshot;
