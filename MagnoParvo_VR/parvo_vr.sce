...
array {
   picture { bitmap { filename =  "pooh.bmp";}; x = 0; y = 0; } pooh;
   picture { bitmap { filename =  "eeyore.bmp";}; x = 0; y = 0; } eeyore;
   picture { bitmap { filename =  "tigger.bmp";}; x = 0; y = 0; } tigger;
   picture { bitmap { filename =  "owl.bmp";}; x = 0; y = 0; } owl;
   picture { bitmap { filename =  "piglet.bmp";}; x = 0; y = 0; } piglet;
   picture { bitmap { filename =  "kanga-roo.bmp";}; x = 0; y = 0; } kanga;
   picture { bitmap { filename =  "rabbit.bmp";}; x = 0; y = 0; } rabbit; 
} target_array;        

picture { bitmap { filename =  "poohgroup.bmp";}; x = 0; y = 0; } groupshot; 
